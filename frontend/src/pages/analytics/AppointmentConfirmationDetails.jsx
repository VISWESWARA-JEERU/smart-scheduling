...
function AppointmentConfirmationDetails() {
    ...
    const fetchDetails = async () => {
        try {
            ...
            const res = await API.get("/analytics/appointment-confirmation", {
                params: {
                    month: selectedMonth,
                    year: selectedYear,
                },
            ...
            console.log("Appointment Confirmation – Details:", res.data);
            setData(res.data);
        } catch (error) {
    ...
    const cards = [
        {
            ...
            value: data.cards?.total_appointments|| 0,
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500">
                            Overview of Appointment confimation AI voice agent received.
                        </p>
                    </div>
                </div>
            ...
            <div className="mb-6 grid grid-cols-1 gap-6 xl:grid-cols-4">
                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm xl:col-span-3">
                    <div className="mb-4">
                        ...
                        <p className="text-sm text-slate-500">
                           Daily trend of appointment confirmation/inquiry requests{" "}
                        ...
                        <tfoot className="border-t bg-slate-50 font-bold text-slate-900">
                            <tr>
                                ...
                                <td className="px-4 py-3">
                                    {data.cards?.total_appointments || 0}
                                </td>
