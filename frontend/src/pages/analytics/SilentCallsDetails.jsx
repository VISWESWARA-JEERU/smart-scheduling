...
function SilentCallDetails() {
    ...
    const fetchDetails = async () => {
        try {
            ...
            const res = await API.get("/analytics/silent-calls", {
                params: {
                    month: selectedMonth,
                    year: selectedYear,
                },
            ...
            console.log("Silent Call Details:", res.data);
            setData(res.data);
        } catch (error) {
            console.error("Silent Call API Error:", error);
        } finally {
            setLoading(false);
        }
    };
    ...
    const cards = [
        {
            ...
            value: data.cards?.SilentCall_request || 0,
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900">
                            Silent Calls– Details
                        </h1>
                        <p className="text-sm text-slate-500">
                            Overview of Silent Calls AI voice agent requests received.
                        </p>
                    </div>
                </div>
            ...
            <div className="mb-6 grid grid-cols-1 gap-6 xl:grid-cols-4">
                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm xl:col-span-3">
                    <div className="mb-4">
                        <h2 className="text-lg font-bold text-slate-900">
                            Silent Call Requests Over Time
                        </h2>
                        <p className="text-sm text-slate-500">
                ...
                <div className="rounded-2xl border border-blue-100 bg-blue-50 p-6 shadow-sm">
                    ...
                    <p className="mt-4 text-sm leading-6 text-slate-600">
                        Silent Calls Analytics tracks calls where the user did not provide any valid request or the call ended without a clear intent.
                    </p>
                        ...
                        <tfoot className="border-t bg-slate-50 font-bold text-slate-900">
                            <tr>
                                ...
                                <td className="px-4 py-3">
                                    {data.cards?.SilentCall_request|| 0}
                                </td>
...
export default SilentCallDetails;