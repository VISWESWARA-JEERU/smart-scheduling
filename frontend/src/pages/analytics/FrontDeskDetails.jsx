...
function FrontDeskDetails() {
    ...
    const fetchDetails = async () => {
        try {
            ...
            const res = await API.get("/analytics/front-desk", {
                params: {
                    month: selectedMonth,
                    year: selectedYear,
                },
            ...
            console.log("Front Desk Details:", res.data);
            setData(res.data);
        } catch (error) {
    ...
    const cards = [
        {
            ...
            value: data.cards?.FrontDesk_request|| 0,
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900">
                           Front Desk Requests – Details
                        </h1>
                        <p className="text-sm text-slate-500">
                            Overview of all front desk related requests handled by the AI voice agent.
                        </p>
                    </div>
                </div>
            ...
            <div className="mb-6 grid grid-cols-1 gap-6 xl:grid-cols-4">
                ...
                <div className="rounded-2xl border border-blue-100 bg-blue-50 p-6 shadow-sm">
                    ...
                    <p className="mt-4 text-sm leading-6 text-slate-600">
                        This metric represents all requests
                        that required front desk assistance
                        or front desk related actions.
                    </p>
                        ...
                        <tfoot className="border-t bg-slate-50 font-bold text-slate-900">
                            <tr>
                                ...
                                <td className="px-4 py-3">
                                    {data.cards?.FrontDesk_request || 0}
                                </td>
